...
RegisterCommand('-scenecreate', function()
    ...
    local scene = exports["interact"]:KeyboardInput({header = "Add Scene",rows = {{id = 0,txt = "Message"},{id = 1,txt = "Color {white, red, blue, green, yellow, purple}"},{id = 2,txt = "Distance {1.1 - 10.0}"},}})
    ...
    print(coords, message, color, distance)
end)
