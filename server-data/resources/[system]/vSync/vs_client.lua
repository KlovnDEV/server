...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/w', 'Change the weather.', {{ name="weatherType", help="Available types: extrasunny, clear, neutral, smog, foggy, overcast, clouds, clearing, rain, thunder, snow, blizzard, snowlight, xmas & halloween"}})
    TriggerEvent('chat:addSuggestion', '/t', 'Change the time.', {{ name="hours", help="A number between 0 - 23"}, { name="minutes", help="A number between 0 - 59"}})
    TriggerEvent('chat:addSuggestion', '/ft', 'Freeze / unfreeze time.')
    TriggerEvent('chat:addSuggestion', '/fw', 'Enable/disable dynamic weather changes.')
