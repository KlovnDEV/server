...
const SubmitData = () => {
    ...
    $.post(`https://interact/dataPost`, JSON.stringify({data: returnData}))
}


const PostData = (data) => {
    return $.post(`https://interact/dataPost`, JSON.stringify(data))
}
