...
AddEventHandler('server-utilities:coords', function(source, args, rawCommand)
    plr = PlayerPedId()
    SetEntityCoords(plr, args[1], args[2], args[3])
end)

RegisterNetEvent('server-utilities:teleportxyz')
AddEventHandler('server-utilities:teleportxyz', function()
    plr = PlayerPedId()
